# TravelHub --- Implementation Prompt Phase 1 — Baseline 1.3 SYNC
...
Оба значения сохраняются. `id` --- внутренний business ID, `number` ---
...
Зафиксируй в коде/документации, что после Phase 2 основной Order
создается consumer-ом `OrderRequested`.
