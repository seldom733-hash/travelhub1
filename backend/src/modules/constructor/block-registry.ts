...
export const BLOCK_REGISTRY: BlockRegistryEntry[] = [
  ...
  },
  {
    ...
    version: 1,
    category: "marketplace",
    displayName: { ru: "Новые предложения", az: "Son təkliflər", en: "Latest Offers" },
    description: { ru: "Свежие предложения от партнёров", az: "Tərəfdaşlardan son təkliflər", en: "Fresh offers from partners" },
    allowedContexts: ["marketplace"],
    allowedLayouts: ["grid-4", "grid-3", "grid-2", "full-width"],
    defaultSettings: { pageSize: 6 },
    defaultLayout: "grid-4",
