...
export const PAGE_REGISTRY: PageDefinition[] = [
  {
    ...
    roleDefaults: {
      ADMIN: [
        "gmv", "qualified-gmv", "collected-gmv", "outstanding", "completed-gmv",
        "revenue", "refunds", "orders", "bookings", "aov", "conversion",
        "orders-fulfilled", "bookings-confirmed", "bookings-completed",
        "payments-captured", "refunds-processed", "funnel",
        "commission", "reconciliation", "payments", "net-payments",
        "sessions", "storefront-sessions",
        "marketplace-partners", "storefront-partners",
        "marketplace-customers", "storefront-customers",
        "storefront-mrr", "storefront-arr", "storefront-collected", "storefront-outstanding",
        "published-services", "archived-services", "services-without-sales",
        "high-demand-services", "low-conversion-services", "total-categories",
        "marketplace-gmv", "storefront-gmv", "marketplace-revenue", "storefront-revenue",
        "marketplace-orders", "storefront-orders", "marketplace-conversion", "storefront-conversion",
      ],
      DIRECTOR: [
        "gmv", "qualified-gmv", "collected-gmv", "outstanding", "completed-gmv",
        "revenue", "refunds", "orders", "bookings", "aov", "conversion",
...
export const WIDGET_REGISTRY: WidgetDefinition[] = [
  ...
  {
    widgetId: "storefront-mrr",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Storefront MRR",
    permission: "analytics.read",
    sectionPermission: "dashboard.marketplace.read",
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.storefrontMrr", version: 1,
  },
  {
    widgetId: "storefront-arr",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Storefront ARR",
    permission: "analytics.read",
    sectionPermission: "dashboard.marketplace.read",
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.storefrontArr", version: 1,
  },
  {
    widgetId: "storefront-collected",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.storefrontCollected", version: 1,
  },
  {
    widgetId: "storefront-outstanding",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.storefrontOutstanding", version: 1,
  },
  {
  ...
  // ─── Catalog Health ──────────────────────────────────────────────
  {
    widgetId: "published-services",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Published Services",
    permission: "analytics.read",
    sectionPermission: "dashboard.catalog.read",
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.publishedServices", version: 1,
  },
  {
    widgetId: "archived-services",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.archivedServices", version: 1,
  },
  {
    widgetId: "services-without-sales",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Services Without Sales",
    permission: "analytics.read",
    sectionPermission: "dashboard.catalog.read",
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.servicesWithoutSales", version: 1,
  },
  {
    widgetId: "high-demand-services",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.highDemandServices", version: 1,
  },
  {
    widgetId: "low-conversion-services",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Low Conversion Services",
    permission: "analytics.read",
    sectionPermission: "dashboard.catalog.read",
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.lowConversionServices", version: 1,
  },
  {
    widgetId: "total-categories",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.totalCategories", version: 1,
  },
  // ─── Channel Health ───────────────────────────────────────────────
  {
    widgetId: "marketplace-gmv",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Marketplace GMV",
    permission: "analytics.read",
    sectionPermission: "dashboard.channels.read",
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.marketplaceGmv", version: 1,
  },
  {
    widgetId: "storefront-gmv",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Storefront GMV",
    permission: "analytics.read",
    sectionPermission: "dashboard.channels.read",
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.storefrontGmv", version: 1,
  },
  {
    widgetId: "marketplace-revenue",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.marketplaceRevenue", version: 1,
  },
  {
    widgetId: "storefront-revenue",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.storefrontRevenue", version: 1,
  },
  {
    widgetId: "marketplace-orders",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.marketplaceOrders", version: 1,
  },
  {
    widgetId: "storefront-orders",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.storefrontOrders", version: 1,
  },
  {
    widgetId: "marketplace-conversion",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.marketplaceConversion", version: 1,
  },
  {
    widgetId: "storefront-conversion",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    minW: 1, minH: 1, maxW: 2, maxH: 2, defaultW: 1, defaultH: 1,
    movable: true, resizable: false, removable: true, required: false,
    dataSource: "dashboard.summary.storefrontConversion", version: 1,
  },
  // Time Series
  {
