...
export const WIDGET_REGISTRY: WidgetDefinition[] = [
  ...
  },
  {
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.qualifiedGmv",
    version: 1,
  },
  {
    widgetId: "collected-gmv",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Collected GMV",
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.collectedGmv",
    version: 1,
  },
  {
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.outstandingGmv",
    version: 1,
  },
  {
    widgetId: "completed-gmv",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Completed GMV",
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.completedGmv",
    version: 1,
  },
  {
    widgetId: "revenue",
  ...
  },
  {
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.totalRefunds",
    version: 1,
  },
  {
    widgetId: "orders",
  ...
  // ─── Operational Individual KPIs ────────────────────────────────────────
  {
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.ordersFulfilled",
    version: 1,
  },
  {
    widgetId: "bookings-confirmed",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.bookingsConfirmed",
    version: 1,
  },
  {
    widgetId: "bookings-completed",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.bookingsCompleted",
    version: 1,
  },
  {
    widgetId: "payments-captured",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
  ...
  },
  {
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.refundsProcessed",
    version: 1,
  },
  // Charts
  {
  ...
  },
  {
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.marketplacePartners",
    version: 1,
  },
  {
    widgetId: "storefront-partners",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.storefrontPartners",
    version: 1,
  },
  {
    widgetId: "marketplace-customers",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.marketplaceCustomers",
    version: 1,
  },
  {
    widgetId: "storefront-customers",
    pageIds: ["command-center"],
    type: "kpi-card",
    category: "KPI",
    title: "Storefront Buyers",
    permission: "analytics.read",
    sectionPermission: "dashboard.marketplace.read",
    minW: 1,
    minH: 1,
    ...
    removable: true,
    required: false,
    dataSource: "dashboard.summary.storefrontCustomers",
    version: 1,
  },
  // Time Series
  {
