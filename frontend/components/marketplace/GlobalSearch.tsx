...
import { MapPin, MagnifyingGlass, CalendarBlank } from "@phosphor-icons/react";
...
export default function GlobalSearch() {
  ...
  return (
    <form
      ...
      role="search"
      className="search-glass rounded-2xl p-2 sm:p-3"
    >
      <div className="flex flex-col gap-2 sm:flex-row">
        ...
        <button
          type="submit"
          className="btn-gold flex items-center justify-center gap-2 rounded-xl px-8 py-3 text-sm font-semibold"
        >
