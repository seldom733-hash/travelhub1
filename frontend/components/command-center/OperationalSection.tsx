...
export function OperationalSection({ data, positions, editing, locale = "ru" }: Props) {
  return (
    <section aria-labelledby="section-operational">
      ...
      {isWidgetVisible(positions, "funnel") && (
...
function FunnelRow({
  ...
  if (kpi.deltaPercent !== null && kpi.deltaPercent !== undefined) {
    ...
    // For refunds: increase = negative, decrease = positive
