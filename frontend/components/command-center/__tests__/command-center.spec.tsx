  ...
  return {
    ...
    sections: {
      ...
      storefrontSaaS: {
        ...
        storefrontMrr: makeKpi(1930, 1760, 170, 9.7),
        storefrontArr: makeKpi(23160, 21120, 2040, 9.7),
        storefrontCollected: makeKpi(1930, 1760, 170, 9.7),
        storefrontOutstanding: makeKpi(0, 0, 0, 0),
      },
      ...overrides,
    },
  };
...
describe("Command Center i18n keys", () => {
  it("all cc.* keys exist in DICT", async () => {
    ...
    expect(DICT["cc.title"].ru).toBe("Центр управления");
