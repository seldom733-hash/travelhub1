...
export default function PartnerActivity({ partnerId }: { partnerId: string }) {
  ...
  const load = useCallback(
    async (cursor?: string, replace = false) => {
      ...
      try {
        const res = await activityApi.listPartner(partnerId, {
    ...
    [partnerId, sourceFilter, dateFrom, dateTo],
  );
