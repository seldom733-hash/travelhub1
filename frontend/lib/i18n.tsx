...
export const DICT: Record<string, Record<Locale, string>> = {
  ...
  // section names
  "cc.section.executive": { ru: "Executive Summary", az: "İdarəetmə Xülasəsi", en: "Executive Summary" },
  "cc.section.operational": { ru: "Operational", az: "Əməliyyat", en: "Operational" },
  "cc.section.financial": { ru: "Financial", az: "Maliyyə", en: "Financial" },
  "cc.section.marketplace": { ru: "Marketplace", az: "Bazar yeri", en: "Marketplace" },
  // KPI titles
  "cc.kpi.gmv": { ru: "GMV", az: "GMV", en: "GMV" },
  "cc.kpi.revenue": { ru: "Revenue", az: "Gəlir", en: "Revenue" },
  "cc.kpi.netRevenue": { ru: "Net Revenue", az: "Xalis gəlir", en: "Net Revenue" },
  "cc.kpi.net-revenue": { ru: "Net Revenue", az: "Xalis gəlir", en: "Net Revenue" },
  "cc.kpi.orders": { ru: "Orders", az: "Sifarişlər", en: "Orders" },
  "cc.kpi.bookings": { ru: "Bookings", az: "Bronlar", en: "Bookings" },
  "cc.kpi.aov": { ru: "AOV", az: "AOV", en: "AOV" },
  "cc.kpi.conversion": { ru: "Conversion", az: "Konversiya", en: "Conversion" },
  ...
  "cc.kpi.funnel": { ru: "Funnel Conversion", az: "Funnel konversiyası", en: "Funnel Conversion" },
  "cc.kpi.commission": { ru: "Commission", az: "Komissiya", en: "Commission" },
  "cc.kpi.payments": { ru: "Payments", az: "Ödənişlər", en: "Payments" },
  "cc.kpi.netPayments": { ru: "Net Payments", az: "Xalis ödənişlər", en: "Net Payments" },
  "cc.kpi.net-payments": { ru: "Net Payments", az: "Xalis ödənişlər", en: "Net Payments" },
  "cc.kpi.reconciliation": { ru: "Reconciliation", az: "Uyğunlaşma", en: "Reconciliation" },
  "cc.kpi.sessions": { ru: "Sessions", az: "Seanslar", en: "Sessions" },
  "cc.kpi.storefrontSessions": { ru: "Storefront Sessions", az: "Vitrin seansları", en: "Storefront Sessions" },
  "cc.kpi.storefront-sessions": { ru: "Storefront Sessions", az: "Vitrin seansları", en: "Storefront Sessions" },
  "cc.kpi.partners": { ru: "Partners", az: "Tərəfdaşlar", en: "Partners" },
  "cc.kpi.customers": { ru: "Customers", az: "Müştərilər", en: "Customers" },
