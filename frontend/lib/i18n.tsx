...
export const DICT: Record<string, Record<Locale, string>> = {
  ...
  "nav.destinations": { ru: "Направления", az: "İstiqamətlər", en: "Destinations" },
  "nav.offers": { ru: "Предложения", az: "Təkliflər", en: "Offers" },
  "nav.for_partners": { ru: "Для партнёров", az: "Tərəfdaşlar üçün", en: "For partners" },
  "nav.favorites": { ru: "Избранное", az: "Seçilmişlər", en: "Favorites" },
  "nav.notifications": { ru: "Уведомления", az: "Bildirişlər", en: "Notifications" },
  "nav.cart": { ru: "Корзина", az: "Səbət", en: "Cart" },

  // marketplace dark theme
  "marketplace.hero_title_1": { ru: "Единая экосистема", az: "Vahid ekosistem", en: "A unified ecosystem" },
  "marketplace.hero_title_2": { ru: "для путешествий", az: "səyahətlər üçün", en: "for travel" },
  "marketplace.hero_description": {
  ...
  "marketplace.search_what_placeholder": { ru: "Туры, отели, трансферы...", az: "Turlar, otellər, transferlər...", en: "Tours, hotels, transfers..." },
  "marketplace.search_dates_label": { ru: "Даты", az: "Tarixlər", en: "Dates" },
  "marketplace.search_dates_placeholder": { ru: "Выберите даты", az: "Tarix seçin", en: "Select dates" },
  "marketplace.search_submit": { ru: "Найти", az: "Axtar", en: "Find" },

  // ── Hero Search tabs & fields ──
  "search.tab_tours": { ru: "Туры", az: "Turlar", en: "Tours" },
  "search.tab_hotels": { ru: "Отели", az: "Hotellər", en: "Hotels" },
  "search.tab_flights": { ru: "Авиабилеты", az: "Aviabiletlər", en: "Flights" },
  "search.tab_sanatoriums": { ru: "Санатории", az: "Sanatoriyalar", en: "Sanatoriums" },
  "search.tab_guides": { ru: "Гиды", az: "Bələdçilər", en: "Guides" },
  "search.tab_excursions": { ru: "Экскурсии", az: "Ekskursiyalar", en: "Excursions" },
  "search.tab_transfers": { ru: "Трансферы", az: "Transferlər", en: "Transfers" },
  "search.tab_car_rental": { ru: "Аренда авто", az: "Avtomobil kirayəsi", en: "Car Rental" },
  "search.tab_railway": { ru: "Ж/д билеты", az: "Dəmir yolu biletləri", en: "Railway" },
  "search.tab_cruises": { ru: "Круизы", az: "Kruizlər", en: "Cruises" },
  "search.from": { ru: "Откуда", az: "Haradan", en: "From" },
  "search.to": { ru: "Куда", az: "Haraya", en: "To" },
  "search.destination": { ru: "Направление", az: "İstiqamət", en: "Destination" },
  "search.city": { ru: "Город", az: "Şəhər", en: "City" },
  "search.hotel": { ru: "Отель", az: "Otel", en: "Hotel" },
  "search.hotel_placeholder": { ru: "Найдите или выберите отель", az: "Otel tapın və ya seçin", en: "Find or select hotel" },
  "search.date": { ru: "Дата", az: "Tarix", en: "Date" },
  "search.check_in": { ru: "Заезд", az: "Giriş", en: "Check-in" },
  "search.check_out": { ru: "Выезд", az: "Çıxış", en: "Check-out" },
  "search.nights": { ru: "Ночей", az: "Gece", en: "Nights" },
  "search.adults": { ru: "Взрослые", az: "Böyüklər", en: "Adults" },
  "search.children": { ru: "Дети", az: "Uşaqlar", en: "Children" },
  "search.infants": { ru: "Младенцы", az: "Körpələr", en: "Infants" },
  "search.child_age": { ru: "Возраст ребёнка", az: "Uşağın yaşı", en: "Child age" },
  "search.departure_date": { ru: "Дата вылета", az: "Uçuş tarixi", en: "Departure date" },
  "search.return_date": { ru: "Дата возвращения", az: "Qayıdış tarixi", en: "Return date" },
  "search.round_trip": { ru: "Туда-обратно", az: "Gediş-dönüş", en: "Round trip" },
  "search.service_class": { ru: "Класс обслуживания", az: "Xidmət sinfi", en: "Service class" },
  "search.class_economy": { ru: "Эконом", az: "Ekonom", en: "Economy" },
  "search.class_business": { ru: "Бизнес", az: "Biznes", en: "Business" },
  "search.class_first": { ru: "Первый", az: "Birinci", en: "First" },
  "search.baggage": { ru: "Багаж", az: "Bağaj", en: "Baggage" },
  "search.baggage_included": { ru: "Только с багажом", az: "Yalnız baqajla", en: "With baggage only" },
  "search.duration": { ru: "Длительность", az: "Müddət", en: "Duration" },
  "search.days": { ru: "дней", az: "gün", en: "days" },
  "search.language": { ru: "Язык", az: "Dil", en: "Language" },
  "search.passengers": { ru: "Пассажиры", az: "Sərnişinlər", en: "Passengers" },
  "search.time": { ru: "Время", az: "Vaxt", en: "Time" },
  "search.pickup": { ru: "Место получения", az: "Götürülmə yeri", en: "Pickup location" },
  "search.dropoff": { ru: "Место возврата", az: "Qaytarılma yeri", en: "Drop-off location" },
  "search.driver_age": { ru: "Возраст водителя", az: "Sürücü yaşı", en: "Driver age" },
  "search.select_hotel": { ru: "Выбрать отель", az: "Otel seçin", en: "Select hotel" },
  "search.optional": { ru: "Необязательно", az: "Məcburi deyil", en: "Optional" },
  "search.help_find": { ru: "Помочь найти", az: "Tapmağa kömək edin", en: "Help find" },
  "search.change_hotel": { ru: "Выбрать другой отель", az: "Başqa otel seçin", en: "Change hotel" },
  "search.no_offers": { ru: "Для выбранного отеля на эти даты подходящих предложений не найдено", az: "Seçilmiş otel üçün bu tarixlərdə uyğun təklif tapılmadı", en: "No matching offers found for the selected hotel on these dates" },
  "search.show_all": { ru: "Показать все результаты", az: "Bütün nəticələri göstər", en: "Show all results" },
  "search.no_results": { ru: "Ничего не найдено", az: "Heç nə tapılmadı", en: "No results found" },
  "search.searching": { ru: "Поиск...", az: "Axtarır...", en: "Searching..." },
  "search.min_chars": { ru: "Введите минимум 2 символа", az: "Minimum 2 simvol daxil edin", en: "Enter at least 2 characters" },

  "marketplace.category_accommodation": { ru: "Проживание", az: "Yerləşmə", en: "Accommodation" },
  "marketplace.category_tours": { ru: "Туры", az: "Turlar", en: "Tours" },
  "marketplace.category_excursions": { ru: "Экскурсии", az: "Ekskursiyalar", en: "Excursions" },
  "marketplace.category_transfers": { ru: "Трансферы", az: "Transferlər", en: "Transfers" },
  "marketplace.category_experiences": { ru: "Впечатления", az: "Təəssüratlar", en: "Experiences" },
  "marketplace.category_wellness": { ru: "Wellness", az: "Wellness", en: "Wellness" },
  "marketplace.category_gastronomy": { ru: "Гастрономия", az: "Qastronomiya", en: "Gastronomy" },
  "marketplace.category_more": { ru: "Ещё", az: "Daha çox", en: "More" },
  "marketplace.hot_tours_title": { ru: "Горящие туры", az: "Son dəqiqə turları", en: "Hot Tours" },
  "marketplace.hot_tours_subtitle": { ru: "Лучшие предложения прямо сейчас", az: "Ən yaxşı təkliflər indi", en: "Best offers right now" },
  "marketplace.all_hot_tours": { ru: "Все горящие туры", az: "Bütün son dəqiqə turları", en: "All hot tours" },
  "marketplace.hot_tours_empty": { ru: "Горящие туры появятся скоро", az: "Son dəqiqə turları tezliklə görünəcək", en: "Hot tours coming soon" },
  "marketplace.nights_count": { ru: "{n} ночей", az: "{n} gece", en: "{n} nights" },
  "marketplace.latest_offers_title": { ru: "Новые предложения", az: "Son təkliflər", en: "Latest Offers" },
  "marketplace.latest_offers_subtitle": { ru: "Свежие предложения от наших партнёров", az: "Tərəfdaşlarımızdan son təkliflər", en: "Fresh offers from our partners" },
  "marketplace.latest_offers_empty": { ru: "Пока новых предложений нет", az: "Hələ yeni təkliflər yoxdur", en: "No new offers yet" },
  "marketplace.latest_offers_empty_hint": { ru: "Новые предложения наших партнёров появятся здесь.", az: "Tərəfdaşlarımızın yeni təklifləri burada görünəcək.", en: "New offers from our partners will appear here." },
  "marketplace.all_latest": { ru: "Все новые", az: "Hamısı yeni", en: "All latest" },
  "marketplace.just_now": { ru: "только что", az: "indi", en: "just now" },
  "marketplace.special_offers_title": { ru: "Скидки и спецпредложения", az: "Endirimlər və xüsusi təkliflər", en: "Discounts & Special Offers" },
  "marketplace.special_offers_subtitle": { ru: "Лучшие цены на популярные услуги", az: "Populyar xidmətlərdə ən yaxşı qiymətlər", en: "Best prices on popular services" },
  "marketplace.all_offers": { ru: "Все предложения", az: "Bütün təkliflər", en: "All offers" },
  "marketplace.tours_title": { ru: "Туры", az: "Turlar", en: "Tours" },
  "marketplace.tours_subtitle": { ru: "Актуальные предложения от партнёров", az: "Tərəfdaşlardan aktual təkliflər", en: "Current offers from partners" },
  "marketplace.all_tours": { ru: "Все туры", az: "Bütün turlar", en: "All tours" },
  "marketplace.hotels_title": { ru: "Отели", az: "Hotellər", en: "Hotels" },
  "marketplace.hotels_subtitle": { ru: "Лучшие отели для вашего отдыха", az: "Dincəlmək üçün ən yaxşı hotellər", en: "Best hotels for your stay" },
  "marketplace.all_hotels": { ru: "Все отели", az: "Bütün hotellər", en: "All hotels" },
  ...
  "marketplace.why_travelhub": { ru: "Почему TravelHub", az: "Niyə TravelHub", en: "Why TravelHub" },
  "marketplace.trust_1_title": { ru: "Проверенные партнёры", az: "Təsdiqlənmiş tərəfdaşlar", en: "Verified partners" },
  "marketplace.trust_1_text": { ru: "Каждая услуга проходит модерацию перед публикацией на витрине.", az: "Hər xidmət vitrinə yerləşdirilməzdən əvvəl moderasiyadan keçir.", en: "Every service is moderated before being listed on the marketplace." },
  "marketplace.trust_2_title": { ru: "Прозрачные цены", az: "Şəffaf qiymətlər", en: "Transparent pricing" },
  "marketplace.trust_2_text": { ru: "Цены от партнёров без скрытых наценок. Вы видите реальную стоимость.", az: "Tərəfdaşların qiymətləri gizli əlavələr olmadan. Reallıq dəyərini görürsünüz.", en: "Partner prices with no hidden markups. You see the real cost." },
  "marketplace.trust_3_title": { ru: "Глобальный охват", az: "Qlobal əhatə", en: "Global coverage" },
  "marketplace.trust_3_text": { ru: "Туры, отели, экскурсии, транспорт и многое другое из одного места.", az: "Turlar, otellər, ekskursiyalar, nəqliyyat və daha çox bir yerdən.", en: "Tours, hotels, excursions, transport and more from one place." },
  "marketplace.partner_cta_title": { ru: "Станьте партнёром TravelHub", az: "TravelHub tərəfdaşı olun", en: "Become a TravelHub partner" },
  "marketplace.partner_cta_text": {
    ru: "Продавайте свои туристические услуги на глобальной витрине. TravelHub giúp bạn tiếp cận hàng nghìn khách hàng.",
    az: "Turizm xidmətlərinizi qlobal vitrində sat. TravelHub minlərlə müştəriyə çatmağa kömək edir.",
    en: "Sell your travel services on a global marketplace. TravelHub helps you reach thousands of customers.",
  },
  "marketplace.partner_cta_button": { ru: "Начать сейчас", az: "İndi başla", en: "Get started" },
  ...
  "card.night": { ru: "ночь", az: "gecə", en: "night" },
  "card.nights": { ru: "ночей", az: "gecə", en: "nights" },
  "card.from_price": { ru: "от", az: "\u00f6n", en: "from" },

  // tour detail
  "tour.filters_title": { ru: "Фильтры", az: "Filtrl\u0259r", en: "Filters" },
  "tour.calendar_title": { ru: "\u041a\u0430\u043b\u0435\u043d\u0434\u0430\u0440\u044c \u0446\u0435\u043d", az: "Qiym\u0259t t\u0259qvimi", en: "Price Calendar" },
  "tour.select_date": { ru: "\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0434\u0430\u0442\u0443", az: "Tarixi s\u0259\u00e7in", en: "Select date" },
  "tour.offers_title": { ru: "\u0412\u0430\u0440\u0438\u0430\u043d\u0442\u044b \u043f\u0440\u0435\u0434\u043b\u043e\u0436\u0435\u043d\u0438\u0439", az: "T\u0259klifl\u0259r", en: "Offer Options" },
  "tour.no_offers": { ru: "\u041f\u0440\u0435\u0434\u043b\u043e\u0436\u0435\u043d\u0438\u0439 \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e", az: "T\u0259klif tap\u0131lmad\u0131", en: "No offers found" },
  "tour.departure": { ru: "\u0412\u044b\u043b\u0435\u0442", az: "\u0130nfis", en: "Departure" },
  "tour.arrival": { ru: "\u041f\u0440\u0438\u0431\u044b\u0442\u0438\u0435", az: "G\u0131li\u015f", en: "Arrival" },
  "tour.room": { ru: "\u041d\u043e\u043c\u0435\u0440", az: "Otaq", en: "Room" },
  "tour.meal": { ru: "\u041f\u0438\u0442\u0430\u043d\u0438\u0435", az: "Yem\u0259k", en: "Meal" },
  "tour.passengers": { ru: "\u041f\u0430\u0441\u0441\u0430\u0436\u0438\u0440\u044b", az: "S\u0259rni\u015ftl\u0259r", en: "Passengers" },
  "tour.nights_count": { ru: "\u041d\u043e\u0447\u0435\u0439", az: "Gec\u0259", en: "Nights" },
  "tour.price": { ru: "\u0426\u0435\u043d\u0430", az: "Qiym\u0259t", en: "Price" },
  "tour.loading": { ru: "\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430...", az: "Y\u00fckl\u0259nir...", en: "Loading..." },
  "tour.error": { ru: "\u041e\u0448\u0438\u0431\u043a\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0438", az: "Y\u00fckl\u0259m\u0259 x\u0259tas\u0131", en: "Loading error" },
  "tour.retry": { ru: "\u041f\u043e\u043f\u0440\u043e\u0431\u043e\u0432\u0430\u0442\u044c \u0441\u043d\u043e\u0432\u0430", az: "Yenid\u0259n c\u0259hd edin", en: "Try again" },
  "tour.selection_title": { ru: "\u041f\u043e\u0434\u0431\u043e\u0440 \u0442\u0443\u0440\u0430", az: "Tur se\u00e7imi", en: "Tour Selection" },
  "tour.departure_city": { ru: "\u0413\u043e\u0440\u043e\u0434 \u0432\u044b\u043b\u0435\u0442\u0430", az: "\u0130nfis \u015f\u0259h\u0259ri", en: "Departure city" },
  "tour.adults": { ru: "\u0412\u0437\u0440\u043e\u0441\u043b\u044b\u0435", az: "B\u00f6y\u00fckl\u0259r", en: "Adults" },
  "tour.children": { ru: "\u0414\u0435\u0442\u0438", az: "\u00c7oc\u0131qlar", en: "Children" },
  "tour.child_ages": { ru: "\u0412\u043e\u0437\u0440\u0430\u0441\u0442 \u0440\u0435\u0431\u0435\u043d\u043a\u0430", az: "\u00c7ocuq ya\u015f\u0131", en: "Child age" },

  // offer modal
  "offer.modal_title": { ru: "\u0412\u0430\u0440\u0438\u0430\u043d\u0442\u044b \u0442\u0443\u0440\u0430 \u043d\u0430", az: "Tur variantlar\u0131 ", en: "Tour options for" },
  "offer.outbound": { ru: "\u041f\u0435\u0440\u0435\u043b\u0435\u0442 \u0442\u0443\u0434\u0430", az: "G\u0131li\u015f reysi", en: "Outbound flight" },
  "offer.return": { ru: "\u041f\u0435\u0440\u0435\u043b\u0435\u0442 \u043e\u0431\u0440\u0430\u0442\u043d\u043e", az: "Geri reys", en: "Return flight" },
  "offer.accommodation": { ru: "\u041d\u043e\u043c\u0435\u0440 / \u041f\u0438\u0442\u0430\u043d\u0438\u0435", az: "Otaq / Yem\u0259k", en: "Room / Meal" },
  "offer.for_all": { ru: "\u0437\u0430 \u0432\u0441\u0435\u0445", az: "ham\u0131s\u0131 \u00fc\u00e7\u00fcn", en: "for all" },
  "offer.verify_price": { ru: "\u041f\u0440\u043e\u0432\u0435\u0440\u043a\u0430 \u0446\u0435\u043d\u044b", az: "Qiym\u0259t yoxlamas\u0131", en: "Check price" },
  "offer.checking": { ru: "\u041f\u0440\u043e\u0432\u0435\u0440\u044f\u0435\u043c...", az: "Yoxlan\u0131r...", en: "Checking..." },
  "offer.create_request": { ru: "\u041e\u0444\u043e\u0440\u043c\u0438\u0442\u044c \u0437\u0430\u043f\u0440\u043e\u0441", az: "Sor\u0131ş yaratmaq", en: "Create request" },
  "offer.request_sent": { ru: "\u2713 \u0417\u0430\u043f\u0440\u043e\u0441 \u043e\u0442\u043f\u0440\u0430\u0432\u043b\u0435\u043d", az: "\u018fric\u0259t g\u00f6nd\u0259rildi", en: "Request sent" },
  "offer.creating": { ru: "\u0421\u043e\u0437\u0434\u0430\u043d\u0438\u0435...", az: "Yarad\u0131l\u0131r...", en: "Creating..." },
  "offer.price_changed": { ru: "\u0426\u0435\u043d\u0430 \u0438\u0437\u043c\u0435\u043d\u0438\u043b\u0430\u0441\u044c", az: "Qiym\u0259t d\u0259yi\u015fdi", en: "Price changed" },
  "offer.was": { ru: "\u0411\u044b\u043b\u043e", az: "\u018evv\u0259l", en: "Was" },
  "offer.now": { ru: "\u0421\u0435\u0439\u0447\u0430\u0441", az: "\u0130ndi", en: "Now" },
  ...
  "search.block_title": { ru: "Поиск путешествия", az: "Səyahət axtarışı", en: "Search your trip" },
  "search.results_title": { ru: "Результаты поиска", az: "Axtarış nəticələri", en: "Search results" },
  "search.change_search": { ru: "Изменить поиск", az: "Axtarışı dəyiş", en: "Change search" },
  "search.compact_summary": { ru: "{service} · {from} → {to} · {date} · {guests}", az: "{service} · {from} → {to} · {date} · {guests}", en: "{service} · {from} → {to} · {date} · {guests}" },
  "search.empty_results": { ru: "Подходящих предложений не найдено", az: "Uyğun təklif tapılmadı", en: "No matching offers found" },
  "search.empty_results_hint": { ru: "Попробуйте изменить параметры поиска или запросите помощь в подборе", az: "Axtarış parametrlərini dəyişin və ya kömək istəyin", en: "Try changing search parameters or request help" },
  "search.empty_hotel": { ru: "Для выбранного отеля подходящих предложений нет", az: "Seçilmiş otel üçün uyğun təklif yoxdur", en: "No offers for the selected hotel" },
  "search.empty_hotel_hint": { ru: "Выберите другой отель или запросите помощь в подборе", az: "Başqa otel seçin və ya kömək istəyin", en: "Select a different hotel or request help" },
  "search.service_tours": { ru: "Туры", az: "Turlar", en: "Tours" },
  "search.service_hotels": { ru: "Отели", az: "Hotellər", en: "Hotels" },
  "search.service_flights": { ru: "Авиабилеты", az: "Aviabiletlər", en: "Flights" },
  "search.service_sanatoriums": { ru: "Санатории", az: "Sanatoriyalar", en: "Sanatoriums" },
  "search.service_guides": { ru: "Гиды", az: "Bələdçilər", en: "Guides" },
  "search.service_excursions": { ru: "Экскурсии", az: "Ekskursiyalar", en: "Excursions" },
  "search.service_transfers": { ru: "Трансферы", az: "Transferlər", en: "Transfers" },
  "search.service_car_rental": { ru: "Аренда авто", az: "Avtomobil kirayəsi", en: "Car Rental" },
  "search.service_railway": { ru: "Ж/д билеты", az: "Dəmir yolu biletləri", en: "Railway" },
  "search.service_cruises": { ru: "Круизы", az: "Kruizlər", en: "Cruises" },
  ...
  // Request statuses
  "status.request.NEW": { ru: "Новая", az: "Yeni", en: "New" },
  "status.request.CHECKING": { ru: "На проверке", az: "Yoxlanılır", en: "Checking" },
  "status.request.SUPPLIER_TIMEOUT": { ru: "Таймаут поставщика", az: "Təchizatçı vaxtı", en: "Supplier timeout" },
  "status.request.PRICE_CHANGED": { ru: "Цена изменена", az: "Qiymət dəyişdi", en: "Price changed" },
  "status.request.CUSTOMER_ACCEPTED": { ru: "Клиент принял", az: "Müştəri qəbul etdi", en: "Customer accepted" },
  "status.request.CONFIRMED": { ru: "Подтверждена", az: "Təsdiqlənib", en: "Confirmed" },
  "status.request.CONVERTED": { ru: "Конвертирована", az: "Keçirilib", en: "Converted" },
  "status.request.REJECTED": { ru: "Отклонена", az: "Rədd edilib", en: "Rejected" },
  "status.request.UNAVAILABLE": { ru: "Недоступна", az: "Mövcud deyil", en: "Unavailable" },
  "status.request.EXPIRED": { ru: "Истекла", az: "Vaxtı bitib", en: "Expired" },
  "status.request.CUSTOMER_PAYMENT_TIMEOUT": { ru: "Таймаут оплаты", az: "Ödəniş vaxtı", en: "Payment timeout" },
  "status.request.CANCELLED_BY_CUSTOMER": { ru: "Отменена клиентом", az: "Müştəri ləğv etdi", en: "Cancelled by customer" },
  ...
  "workspace.card.catalog": { ru: "Каталог", az: "Kataloq", en: "Catalog" },
  "workspace.card.catalog.desc": { ru: "Управление товарами, тарифами и availability", az: "Məhsullar, tariflər və availability idarəsi", en: "Manage products, tariffs and availability" },
  "workspace.card.orders": { ru: "Заказы", az: "Sifarişlər", en: "Orders" },
  "workspace.card.orders.desc": { ru: "Обработка и исполнение заказов", az: "Sifarişlərin emalı və icrası", en: "Order processing and fulfillment" },
  "workspace.card.bookings": { ru: "Бронирования", az: "Bronlar", en: "Bookings" },
  "workspace.card.bookings.desc": { ru: "Управление бронированиями и подтверждениями", az: "Bronlamalar və təsdiqlər idarəsi", en: "Manage bookings and confirmations" },
  "workspace.card.crm": { ru: "CRM", az: "CRM", en: "CRM" },
  "workspace.card.crm.desc": { ru: "Клиенты, партнёры и коммерческие отношения", az: "Müştərilər, tərəfdaşlar və kommersiya münasibətləri", en: "Customers, partners and commercial relationships" },
  "workspace.card.marketing": { ru: "Маркетинг", az: "Marketinq", en: "Marketing" },
  "workspace.card.marketing.desc": { ru: "Кампании, аудитории и атрибуция", az: "Kampaniyalar, auditoriyalar və atribusiya", en: "Campaigns, audiences and attribution" },
  "workspace.card.command_center": { ru: "Центр управления", az: "İdarəetmə Mərkəzi", en: "Command Center" },
  "workspace.card.command_center.desc": { ru: "Оперативный обзор, KPI и ключевые события", az: "Əməliyyat icmalı, KPI və açar hadisələr", en: "Operational overview, KPI and key events" },
  "workspace.card.analytics": { ru: "Аналитика", az: "Analitika", en: "Analytics" },
  "workspace.card.analytics.desc": { ru: "Глубокая аналитика, отчёты и тренды", az: "Dərin analitika, hesabatlar və tendensiyalar", en: "Deep analytics, reports and trends" },
  "workspace.card.support": { ru: "Поддержка", az: "Dəstək", en: "Support" },
  "workspace.card.support.desc": { ru: "Тикеты, обращения и решение проблем", az: "Biletlər, sorğular və problemlərin həlli", en: "Tickets, inquiries and issue resolution" },
  "workspace.card.partners": { ru: "Партнёры", az: "Tərəfdaşlar", en: "Partners" },
  "workspace.card.partners.desc": { ru: "Онбординг и управление партнёрами", az: "Onboarding və tərəfdaş idarəsi", en: "Partner onboarding and management" },
  "workspace.card.sellers": { ru: "Продавцы", az: "Satıcılar", en: "Sellers" },
  "workspace.card.sellers.desc": { ru: "Профили продавцов и верификация", az: "Satıcı profilləri və yoxlama", en: "Seller profiles and verification" },
  ...
  "nav.payments": { ru: "Платежи", az: "Ödənişlər", en: "Payments" },
  "nav.finance": { ru: "Финансы", az: "Maliyyə", en: "Finance" },
  "nav.group.operations": { ru: "ОПЕРАЦИИ", az: "ƏMƏLİYYATLAR", en: "OPERATIONS" },
  "nav.group.finance": { ru: "ФИНАНСЫ", az: "MALİYYƏ", en: "FINANCE" },
  "nav.group.commercial": { ru: "КОММЕРЧЕСКОЕ УПРАВЛЕНИЕ", az: "KOMERSİYA İDARƏETMƏSİ", en: "COMMERCIAL MANAGEMENT" },
  "nav.group.partner_network": { ru: "ПАРТНЁРСКАЯ СЕТЬ", az: "TƏRƏFDAŞ ŞƏBƏKƏSİ", en: "PARTNER NETWORK" },
  "nav.group.service": { ru: "СЕРВИС", az: "XİDMƏT", en: "SERVICE" },
  "nav.group.admin": { ru: "АДМИНИСТРИРОВАНИЕ", az: "ADMINİSTRASİYA", en: "ADMINISTRATION" },
  "ops.title": { ru: "Центр операций", az: "Əməliyyat Mərkəzi", en: "Operations Center" },
  "ops.home": { ru: "Главная", az: "Ana səhifə", en: "Home" },
  "ops.breadcrumbs_aria": { ru: "Хлебные крошки", az: "Breadcrumbs", en: "Breadcrumbs" },
  "ops.tabs_aria": { ru: "Разделы центра операций", az: "Əməliyyat mərkəzi bölmələri", en: "Operations Center sections" },
  "ops.loading": { ru: "Загрузка…", az: "Yüklənir…", en: "Loading…" },
  "ops.empty_no_data": { ru: "Данных нет", az: "Məlumat yoxdur", en: "No data" },
  "ops.empty_no_results": { ru: "По заданным фильтрам результатов нет", az: "Seçilmiş filtrlər üzrə nəticə yoxdur", en: "No results for the active filters" },
  "ops.error": { ru: "Не удалось загрузить данные", az: "Məlumatı yükləmək mümkün olmadı", en: "Failed to load data" },
  "ops.retry": { ru: "Повторить", az: "Yenidən cəhd edin", en: "Retry" },
  "ops.period": { ru: "Период:", az: "Dövr:", en: "Period:" },
  "ops.period_from": { ru: "С", az: "Bitdən", en: "From" },
  "ops.period_to": { ru: "По", az: "Qədər", en: "To" },
  "ops.period_clear": { ru: "Очистить период", az: "Dövrü təmizlə", en: "Clear period" },
  "ops.period_aria": { ru: "Фильтр по периоду", az: "Dövr filtri", en: "Period filter" },
  "nav.crm": { ru: "CRM", az: "CRM", en: "CRM" },
  "nav.marketing": { ru: "Маркетинг", az: "Marketinq", en: "Marketing" },
  ...
  "crm.detail.service_date": { ru: "Дата услуги", az: "Xidmət tarixi", en: "Service date" },
  ...
  "crm.detail.payment_status": { ru: "Статус оплаты", az: "Ödəniş statusu", en: "Payment status" },
  ...
  "bookings.financial": { ru: "Финансы", az: "Maliyyə", en: "Financial" },
  "bookings.service": { ru: "Услуга", az: "Xidmət", en: "Service" },
  "bookings.passengers": { ru: "Пассажиры", az: "Sərnişinlər", en: "Passengers" },
  "bookings.timeline": { ru: "Хронология", az: "Xronologiya", en: "Timeline" },
  "bookings.details": { ru: "Детали", az: "Təfərrüatlar", en: "Details" },
  "bookings.supplier_confirmations": { ru: "Подтверждения поставщика", az: "Təchizatçı təsdiqləri", en: "Supplier confirmations" },
  ...
  "requests.group.lifecycle": { ru: "Жизненный цикл", az: "Sorğu addımı", en: "Request lifecycle" },
  "requests.group.exceptions": { ru: "Проблемы и завершения", az: "Problemlər və nəticələr", en: "Issues and completions" },
  ...
  "detail.sections.relations": { ru: "Связанные сущности", az: "Əlaqəli obyektlər", en: "Relations" },
  "detail.sections.dates": { ru: "Даты", az: "Tarixlər", en: "Dates" },
  "detail.sections.notes": { ru: "Примечания", az: "Qeydlər", en: "Notes" },
  "detail.relation.request": { ru: "Заявка", az: "Sorğu", en: "Request" },
  "detail.relation.booking": { ru: "Бронирование", az: "Bron", en: "Booking" },
  "detail.relation.no_booking": { ru: "Бронирование ещё не создано", az: "Bron hələ yaradılmayıb", en: "No booking created yet" },
  "detail.relation.order": { ru: "Заказ", az: "Sifariş", en: "Order" },
  "detail.relation.no_request": { ru: "Связанная заявка отсутствует", az: "Əlaqəli sorğu yoxdur", en: "No related request" },
  "detail.relation.no_order": { ru: "Связанный заказ отсутствует", az: "Əlaqəli sifariş yoxdur", en: "No related order" },
  "detail.chain.current": { ru: "Текущая", az: "Cari", en: "Current" },
  "detail.dates.terms_accepted": { ru: "Приняты условия", az: "Şərtlər qəbul edilib", en: "Terms accepted" },
  "detail.dates.final_confirmed": { ru: "Финальное подтверждение", az: "Son təsdiq", en: "Final confirmation" },
  "detail.dates.fulfilled": { ru: "Исполнен", az: "İcra edilib", en: "Fulfilled" },
  "detail.dates.closed": { ru: "Закрыт", az: "Bağlanıb", en: "Closed" },
  "detail.dates.cancelled": { ru: "Отменён", az: "Ləğv edilib", en: "Cancelled" },
  "requests.rejection": { ru: "Отклонение", az: "İmtina", en: "Rejection" },
  "booking.status.sent_to_supplier": { ru: "Отправлен поставщику", az: "Təchizatçıya göndərilib", en: "Sent to supplier" },
  "booking.status.awaiting": { ru: "Ожидает подтверждения", az: "Təsdiq gözlənilir", en: "Awaiting confirmation" },
  ...
  "booking.status.rejected": { ru: "Отклонено поставщиком", az: "Təchizatçı rədd edib", en: "Rejected by supplier" },
  ...
  "finance.no_payments": { ru: "Платежей пока нет", az: "Hələ ödəniş yoxdur", en: "No payments yet" },
  "finance.no_refunds": { ru: "Возвратов пока нет", az: "Hələ geri qaytarma yoxdur", en: "No refunds yet" },
  "finance.payment_method": { ru: "Способ оплаты", az: "Ödəniş üsulu", en: "Payment method" },
  "finance.provider_reference": { ru: "Ссылка провайдера", az: "Provayder referansı", en: "Provider reference" },
  "finance.status.PENDING": { ru: "Ожидает", az: "Gözlənilir", en: "Pending" },
  "finance.status.AUTHORIZED": { ru: "Авторизован", az: "İcazə verilib", en: "Authorized" },
  "finance.status.CAPTURED": { ru: "Оплачен", az: "Ödənilib", en: "Captured" },
  "finance.status.FAILED": { ru: "Неудачно", az: "Uğursuz", en: "Failed" },
  "finance.status.CANCELLED": { ru: "Отменён", az: "Ləğv edilib", en: "Cancelled" },
  "finance.status.REFUNDED": { ru: "Возвращён", az: "Geri qaytarılıb", en: "Refunded" },
  "finance.status.REQUESTED": { ru: "Запрошен", az: "İstənilib", en: "Requested" },
  "finance.status.APPROVED": { ru: "Одобрен", az: "Təsdiqlənib", en: "Approved" },
  "finance.status.PROCESSED": { ru: "Обработан", az: "İşlənib", en: "Processed" },
  ...
  "admin.kpi.total_bookings": { ru: "Всего бронирований", az: "Cəmi bronlar", en: "Total bookings" },
  ...
  // KPI group section titles
  "admin.kpi.lifecycle_statuses": { ru: "Статусы", az: "Vəziyyətlər", en: "Statuses" },
  ...
  "aggregate.amount": { ru: "Сумма", az: "Məbləğ", en: "Amount" },
  "aggregate.gmv": { ru: "GMV", az: "GMV", en: "GMV" },
  "aggregate.commission": { ru: "Комиссия", az: "Komissiya", en: "Commission" },
  "aggregate.refunds": { ru: "Возвраты", az: "Geri qayıtmalar", en: "Refunds" },
  ...
  "status.decision.DECLINED": { ru: "Отклонено", az: "İmtina edildi", en: "Declined" },
  // Product types
  ...
  "booking.status.NEW": { ru: "Новое", az: "Yeni", en: "New" },
  "booking.status.PREPARING_REQUEST": { ru: "Подготовка заявки", az: "Sorğu hazırlanır", en: "Preparing request" },
  "booking.status.NEEDS_CLARIFICATION": { ru: "Требует уточнения", az: "Açıqlama tələb olunur", en: "Needs clarification" },
  "booking.status.CHANGE_REQUESTED": { ru: "Запрос на изменение", az: "Dəyişiklik sorğusu", en: "Change requested" },
  "booking.status.CANCELLATION_REQUESTED": { ru: "Запрос на отмену", az: "Ləğv etmə sorğusu", en: "Cancellation requested" },
  "booking.status.PROBLEM": { ru: "Проблема", az: "Problem", en: "Problem" },
  // User statuses
  ...
  // ── Analytics Center ──
  "analytics.title": { ru: "Аналитика", az: "Analitika", en: "Analytics" },
  "analytics.subtitle": { ru: "Глубокий анализ данных", az: "Dərin məlumat analizi", en: "Deep data analysis" },
  "analytics.section.marketplace": { ru: "Маркетплейс", az: "Bazar yeri", en: "Marketplace" },
  "analytics.section.marketplace.desc": { ru: "Показатели продаж, трафика и эффективности TravelHub Marketplace", az: "TravelHub Bazar yeri satış, trafik və səmərəlilik göstəriciləri", en: "Sales, traffic and efficiency metrics for TravelHub Marketplace" },
  "analytics.section.storefrontSaaS": { ru: "Storefront SaaS", az: "Storefront SaaS", en: "Storefront SaaS" },
  "analytics.section.storefrontSaaS.desc": { ru: "Показатели использования Storefront и SaaS-экономики TravelHub", az: "Storefront istifadəsi və TravelHub SaaS iqtisadiyyatı göstəriciləri", en: "Storefront adoption and TravelHub SaaS economics metrics" },
  "analytics.loading": { ru: "Загрузка аналитики…", az: "Analitika yüklənir…", en: "Loading analytics…" },
  ...
  "analytics.kpi.revenue": { ru: "Платежи клиентов", az: "Müştəri ödənişləri", en: "Customer Payments" },
  "analytics.kpi.net_revenue": { ru: "Чистые платежи", az: "Xalis ödənişlər", en: "Net Payments" },
  "analytics.kpi.commission": { ru: "Комиссия", az: "Komissiya", en: "Commission" },
  "analytics.kpi.orders": { ru: "Заказы", az: "Sifarişlər", en: "Orders" },
  "analytics.kpi.bookings": { ru: "Бронирования", az: "Bronlar", en: "Bookings" },
  ...
  "analytics.kpi.storefront_active": { ru: "Активные Storefront", az: "Aktiv Storefront", en: "Active Storefronts" },
  ...
  "analytics.kpi.outstanding_gmv": { ru: "Незакрытый GMV", az: "Açıq GMV", en: "Outstanding GMV" },
  "analytics.kpi.marketplace_visitors": { ru: "Посетители Marketplace", az: "Marketplace ziyarətçiləri", en: "Marketplace Visitors" },
  "analytics.kpi.marketplace_visits": { ru: "Посещения Marketplace", az: "Marketplace ziyarətləri", en: "Marketplace Visits" },
  "analytics.funnel.title": { ru: "Активность по этапам", az: "Mərhələlər üzrə fəaliyyət", en: "Activity by Stage" },
  "analytics.timeseries.title": { ru: "Динамика", az: "Dinamika", en: "Time Series" },
  "analytics.timeseries.granularity": { ru: "Группировка", az: "Qruplaşma", en: "Granularity" },
  "analytics.partners.title": { ru: "Производительность партнёров", az: "Tərəfdaş performansı", en: "Partner Performance" },
  "analytics.finance.title": { ru: "Финансовая сводка", az: "Maliyyə xülasəsi", en: "Financial Summary" },
  "analytics.finance.payments": { ru: "Платежи", az: "Ödənişlər", en: "Payments" },
  "analytics.finance.refunds": { ru: "Возвраты", az: "Geri qaytarmalar", en: "Refunds" },
  "analytics.finance.net": { ru: "Чистые платежи", az: "Xalis ödənişlər", en: "Net payments" },
  ...
  "marketing.tab.campaigns": { ru: "Кампании", az: "Kampaniyalar", en: "Campaigns" },
  "marketing.tab.audiences": { ru: "Аудитории", az: "Auditoriyalar", en: "Audiences" },
  "marketing.tab.attributions": { ru: "Атрибуции", az: "Atributiyalar", en: "Attributions" },
  "marketing.campaigns_empty": { ru: "Кампании не найдены", az: "Kampaniyalar tapılmadı", en: "No campaigns found" },
  "marketing.audiences_empty": { ru: "Аудитории не найдены", az: "Auditoriyalar tapılmadı", en: "No audiences found" },
  "marketing.attributions_empty": { ru: "Атрибуции не найдены", az: "Atributiyalar tapılmadı", en: "No attributions found" },
  "marketing.col.code": { ru: "Код", az: "Kod", en: "Code" },
  "marketing.col.name": { ru: "Название", az: "Ad", en: "Name" },
  "marketing.col.status": { ru: "Статус", az: "Vəziyyət", en: "Status" },
  "marketing.col.scope": { ru: "Область", az: "Sahə", en: "Scope" },
  "marketing.col.created": { ru: "Создано", az: "Yaradıldı", en: "Created" },
  "marketing.col.campaign": { ru: "Кампания", az: "Kampaniya", en: "Campaign" },
  "marketing.col.entity_type": { ru: "Тип объекта", az: "Obyekt növü", en: "Entity Type" },
  "marketing.col.entity_id": { ru: "ID объекта", az: "Obyekt ID", en: "Entity ID" },
  "marketing.col.criteria": { ru: "Критерии", az: "Meyarlar", en: "Criteria" },
  "marketing.scope.platform": { ru: "Платформа", az: "Platforma", en: "Platform" },
  "marketing.create_campaign": { ru: "Создать кампанию", az: "Kampaniya yarat", en: "Create Campaign" },
  "marketing.create.form.name": { ru: "Название", az: "Ad", en: "Name" },
  "marketing.create.form.description": { ru: "Описание", az: "Təsvir", en: "Description" },
  "marketing.create.form.objective": { ru: "Цель", az: "Məqsəd", en: "Objective" },
  "marketing.create.submit": { ru: "Создать", az: "Yarat", en: "Create" },
  "marketing.status.draft": { ru: "Черновик", az: "Qaralama", en: "Draft" },
  "marketing.status.scheduled": { ru: "Запланировано", az: "Planlaşdırılıb", en: "Scheduled" },
  "marketing.status.active": { ru: "Активно", az: "Aktiv", en: "Active" },
  ...
  "marketing.lifecycle.to": { ru: "Перевести в", az: "Keçir", en: "Transition to" },
  "marketing.error.load_failed": { ru: "Ошибка загрузки", az: "Yükləmə xətası", en: "Load failed" },
  "marketing.error.retry": { ru: "Повторить", az: "Yenidən cəhd et", en: "Retry" },

  // ── Support Center (Step 3.11) ─────────────────────────────────────────
  "support.title": { ru: "Поддержка", az: "Dəstək", en: "Support" },
  "support.subtitle": { ru: "Управление обращениями", az: "Müraciətlərin idarəsi", en: "Support cases management" },
  // status
  "support.status.OPEN": { ru: "Открыт", az: "Açıq", en: "Open" },
  "support.status.IN_PROGRESS": { ru: "В работе", az: "İşlənir", en: "In Progress" },
  "support.status.WAITING_CUSTOMER": { ru: "Ожидание клиента", az: "Müştəri gözlənilir", en: "Waiting for customer" },
  "support.status.WAITING_PARTNER": { ru: "Ожидание партнёра", az: "Tərəfdaş gözlənilir", en: "Waiting for partner" },
  "support.status.WAITING_INTERNAL": { ru: "Ожидание (внутр.)", az: "Gözlənilir (daxili)", en: "Waiting (internal)" },
  "support.status.ESCALATED": { ru: "Эскалирован", az: "Miqrasiya edilib", en: "Escalated" },
  "support.status.RESOLVED": { ru: "Решён", az: "Həll edilib", en: "Resolved" },
  "support.status.CLOSED": { ru: "Закрыт", az: "Bağlanıb", en: "Closed" },
  // priority
  "support.priority.LOW": { ru: "Низкий", az: "Aşağı", en: "Low" },
  "support.priority.MEDIUM": { ru: "Средний", az: "Orta", en: "Medium" },
  "support.priority.HIGH": { ru: "Высокий", az: "Yüksək", en: "High" },
  "support.priority.URGENT": { ru: "Срочный", az: "Təcili", en: "Urgent" },
  // case type
  "support.type.GENERAL": { ru: "Общий", az: "Ümumi", en: "General" },
  "support.type.ORDER_ISSUE": { ru: "Проблема с заказом", az: "Sifariş problemi", en: "Order issue" },
  "support.type.BOOKING_ISSUE": { ru: "Проблема с бронью", az: "Bron problemi", en: "Booking issue" },
  "support.type.PAYMENT_ISSUE": { ru: "Проблема с оплатой", az: "Ödəniş problemi", en: "Payment issue" },
  "support.type.REFUND_REQUEST": { ru: "Запрос на возврат", az: "Geri qaytarma sorğusu", en: "Refund request" },
  "support.type.TECHNICAL": { ru: "Технический", az: "Texniki", en: "Technical" },
  "support.type.BILLING": { ru: "Биллинг", az: "Billinq", en: "Billing" },
  "support.type.PARTNER_ISSUE": { ru: "Проблема с партнёром", az: "Tərəfdaş problemi", en: "Partner issue" },
  "support.type.PRODUCT_QUALITY": { ru: "Качество продукта", az: "Məhsul keyfiyyəti", en: "Product quality" },
  // columns
  "support.col.code": { ru: "Код", az: "Kod", en: "Code" },
  "support.col.title": { ru: "Название", az: "Başlıq", en: "Title" },
  "support.col.type": { ru: "Тип", az: "Növ", en: "Type" },
  "support.col.priority": { ru: "Приоритет", az: "Prioritet", en: "Priority" },
  "support.col.status": { ru: "Статус", az: "Status", en: "Status" },
  "support.col.assignee": { ru: "Ответственный", az: "Məsul", en: "Assignee" },
  "support.col.customer": { ru: "Клиент", az: "Müştəri", en: "Customer" },
  "support.col.order": { ru: "Заказ", az: "Sifariş", en: "Order" },
  "support.col.created": { ru: "Создан", az: "Yaradılıb", en: "Created" },
  "support.col.updated": { ru: "Обновлён", az: "Yenilənib", en: "Updated" },
  "support.col.transition_to": { ru: "Перевести", az: "Keçir", en: "Transition to" },
  // actions
  "support.create_case": { ru: "＋ Создать обращение", az: "＋ Müraciət yarat", en: "＋ Create case" },
  "support.refresh": { ru: "⟳", az: "⟳", en: "⟳" },
  // create form
  "support.form.title_label": { ru: "Название", az: "Başlıq", en: "Title" },
  "support.form.title_required": { ru: "Обязательное поле", az: "Məcburi sahə", en: "Required" },
  "support.form.description_label": { ru: "Описание", az: "Təsvir", en: "Description" },
  "support.form.type_label": { ru: "Тип", az: "Növ", en: "Type" },
  "support.form.priority_label": { ru: "Приоритет", az: "Prioritet", en: "Priority" },
  "support.form.source_label": { ru: "Источник", az: "Mənbə", en: "Source" },
  "support.form.customer_id_label": { ru: "ID клиента", az: "Müştəri ID", en: "Customer ID" },
  "support.form.order_id_label": { ru: "ID заказа", az: "Sifariş ID", en: "Order ID" },
  "support.form.booking_id_label": { ru: "ID брони", az: "Bron ID", en: "Booking ID" },
  "support.form.submit": { ru: "Создать", az: "Yarat", en: "Create" },
  "support.form.submitting": { ru: "Создание…", az: "Yaradılır…", en: "Creating…" },
  // detail
  "support.detail.title": { ru: "Обращение", az: "Müraciət", en: "Case" },
  "support.detail.back": { ru: "← К списку", az: "← Siyahıya", en: "← Back to list" },
  "support.detail.summary": { ru: "Сводка", az: "Xülasə", en: "Summary" },
  "support.detail.status": { ru: "Статус", az: "Status", en: "Status" },
  "support.detail.priority": { ru: "Приоритет", az: "Prioritet", en: "Priority" },
  "support.detail.type": { ru: "Тип", az: "Növ", en: "Type" },
  "support.detail.source": { ru: "Источник", az: "Mənbə", en: "Source" },
  "support.detail.customer": { ru: "Клиент", az: "Müştəri", en: "Customer" },
  "support.detail.order": { ru: "Заказ", az: "Sifariş", en: "Order" },
  "support.detail.booking": { ru: "Бронь", az: "Bron", en: "Booking" },
  "support.detail.assignee": { ru: "Ответственный", az: "Məsul", en: "Assignee" },
  "support.detail.created_by": { ru: "Создатель", az: "Yaradan", en: "Created by" },
  "support.detail.created_at": { ru: "Создано", az: "Yaradılıb", en: "Created" },
  "support.detail.sla_deadline": { ru: "Дедлайн SLA", az: "SLA müddəti", en: "SLA deadline" },
  "support.detail.escalated_at": { ru: "Эскалация", az: "Miqrasiya", en: "Escalated" },
  "support.detail.escalation_reason": { ru: "Причина эскалации", az: "Miqrasiya səbəbi", en: "Escalation reason" },
  // assign
  "support.detail.assign": { ru: "Назначить", az: "Təyin et", en: "Assign" },
  "support.detail.assign_to": { ru: "Назначить на…", az: "Təyin et…", en: "Assign to…" },
  "support.detail.assign_submit": { ru: "Назначить", az: "Təyin et", en: "Assign" },
  // escalate
  "support.detail.escalate": { ru: "Эскалировать", az: "Miqrasiya et", en: "Escalate" },
  "support.detail.escalate_reason_label": { ru: "Причина", az: "Səbəb", en: "Reason" },
  "support.detail.escalate_submit": { ru: "Эскалировать", az: "Miqrasiya et", en: "Escalate" },
  // tabs
  "support.tab.comments": { ru: "Комментарии", az: "Şərhlər", en: "Comments" },
  "support.tab.history": { ru: "История", az: "Tarixçə", en: "History" },
  "support.tab.communications": { ru: "Связи", az: "Əlaqələr", en: "Communications" },
  // comments
  "support.comment.body_label": { ru: "Комментарий", az: "Şərh", en: "Comment" },
  "support.comment.internal_label": { ru: "Внутренний комментарий", az: "Daxili şərh", en: "Internal comment" },
  "support.comment.submit": { ru: "Отправить", az: "Göndər", en: "Submit" },
  "support.comment.empty": { ru: "Комментариев пока нет", az: "Hələ şərh yoxdur", en: "No comments yet" },
  // history
  "support.history.empty": { ru: "История пуста", az: "Tarixçə boşdur", en: "No history yet" },
  // communications
  "support.comm.empty": { ru: "Связей пока нет", az: "Hələ əlaqə yoxdur", en: "No communications yet" },
  "support.comm.link": { ru: "Привязать коммуникацию", az: "Əlaqəni birləşdir", en: "Link communication" },
  "support.comm.link_id_label": { ru: "Communication ID", az: "Communication ID", en: "Communication ID" },
  "support.comm.link_submit": { ru: "Привязать", az: "Birləşdir", en: "Link" },
  // stats
  ...
  // errors
  "support.error.load_failed": { ru: "Ошибка загрузки", az: "Yükləmə xətası", en: "Load failed" },
  ...
  // ── Request Center ──
  "requests.title": { ru: "Центр заявок", az: "Sorğu Mərkəzi", en: "Request Center" },
  "requests.kpi.all": { ru: "Все заявки", az: "Bütün sorğular", en: "All requests" },
  "requests.kpi.total": { ru: "Всего заявок", az: "Cəmi sorğular", en: "Total requests" },
  "requests.kpi.new": { ru: "Новые", az: "Yeni", en: "New" },
  "requests.kpi.checking": { ru: "На проверке", az: "Yoxlanılır", en: "Checking" },
  "requests.kpi.price_changed": { ru: "Ожидают решения", az: "Qərar gözləyir", en: "Awaiting decision" },
  "requests.kpi.confirmed": { ru: "Подтверждены", az: "Təsdiqlənib", en: "Confirmed" },
  "requests.kpi.converted": { ru: "Конвертированы", az: "Keçirilib", en: "Converted" },
  "requests.kpi.rejected": { ru: "Отклонены", az: "Rədd edilib", en: "Rejected" },
  "requests.kpi.unavailable": { ru: "Недоступны", az: "Mövcud deyil", en: "Unavailable" },
  "requests.kpi.expired": { ru: "Истекли", az: "Vaxtı bitib", en: "Expired" },
  "requests.kpi.supplier_timeout": { ru: "Таймаут поставщика", az: "Təchizatçı vaxtı bitib", en: "Supplier timeout" },
  "requests.kpi.customer_timeout": { ru: "Таймаут клиента", az: "Müştəri vaxtı bitib", en: "Customer timeout" },
  "requests.kpi.cancelled": { ru: "Отменены клиентом", az: "Müştəri tərəfindən ləğv", en: "Cancelled by customer" },
  "requests.kpi.customer_accepted": { ru: "Принята клиентом", az: "Müştəri tərəfindən qəbul edilib", en: "Customer accepted" },
  "requests.kpi.customer_payment_timeout": { ru: "Таймаут оплаты клиента", az: "Müştəri ödəniş vaxtı bitib", en: "Customer payment timeout" },
  "requests.kpi.cancelled_by_customer": { ru: "Отменена клиентом", az: "Müştəri tərəfindən ləğv edilib", en: "Cancelled by customer" },
  "requests.ref": { ru: "№ Заявки", az: "Sorğu №", en: "Request #" },
  "requests.status.new": { ru: "Новая", az: "Yeni", en: "New" },
  "requests.status.checking": { ru: "На проверке", az: "Yoxlanılır", en: "Checking" },
  "requests.status.price_changed": { ru: "Цена изменена", az: "Qiymət dəyişdi", en: "Price changed" },
  "requests.status.confirmed": { ru: "Подтверждена", az: "Təsdiqlənib", en: "Confirmed" },
  "requests.status.converted": { ru: "Конвертирована", az: "Keçirilib", en: "Converted" },
  "requests.status.rejected": { ru: "Отклонена", az: "Rədd edilib", en: "Rejected" },
  "requests.status.unavailable": { ru: "Недоступна", az: "Mövcud deyil", en: "Unavailable" },
  "requests.status.expired": { ru: "Истекла", az: "Vaxtı bitib", en: "Expired" },
  "requests.status.supplier_timeout": { ru: "Таймаут поставщика", az: "Təchizatçı vaxtı", en: "Supplier timeout" },
  "requests.status.customer_payment_timeout": { ru: "Таймаут оплаты", az: "Ödəniş vaxtı", en: "Payment timeout" },
  "requests.status.cancelled_by_customer": { ru: "Отменена клиентом", az: "Müştəri ləğv etdi", en: "Cancelled by customer" },
  "requests.customer": { ru: "Клиент", az: "Müştəri", en: "Customer" },
  "requests.product": { ru: "Услуга", az: "Xidmət", en: "Service" },
  "requests.supplier": { ru: "Поставщик", az: "Təchizatçı", en: "Supplier" },
  "requests.displayed_price": { ru: "Цена витрины", az: "Vitrin qiyməti", en: "Display price" },
  "requests.confirmed_price": { ru: "Подтв. цена", az: "Təsdiq qiyməti", en: "Confirmed price" },
  "requests.service_date": { ru: "Дата услуги", az: "Xidmət tarixi", en: "Service date" },
  ...
  // ── R2 Detail Visual System — Request detail labels ──
  "requests.quantity": { ru: "Количество", az: "Miqdar", en: "Quantity" },
  "requests.supplier_responded_date": { ru: "Дата ответа поставщика", az: "Təchizatçının cavab tarixi", en: "Supplier response date" },
  "requests.supplier_deadline": { ru: "Дедлайн ответа", az: "Cavab müddəti", en: "Response deadline" },
  "requests.supplier_responded": { ru: "Ответил", az: "Cavab verdi", en: "Responded" },
  "requests.decision": { ru: "Решение", az: "Qərar", en: "Decision" },
  "requests.proposed_price": { ru: "Предложенная цена", az: "Təklif olunan qiymət", en: "Proposed price" },
  "requests.supplier_note": { ru: "Примечание поставщика", az: "Təchizatçı qeydi", en: "Supplier note" },
  "requests.customer_deadline": { ru: "Дедлайн клиента", az: "Müştəri müddəti", en: "Customer deadline" },
  "requests.rejection_date": { ru: "Дата", az: "Tarix", en: "Date" },
  "requests.rejected_by": { ru: "Кем", az: "Kim tərəfindən", en: "Rejected by" },
  "requests.paid_at": { ru: "Оплачено: {date}", az: "Ödənildi: {date}", en: "Paid: {date}" },
  "requests.price_proposal_placeholder": { ru: "Цена", az: "Qiymət", en: "Price" },
  "requests.price_invalid": { ru: "Укажите корректную цену", az: "Düzgün qiymət göstərin", en: "Enter a valid price" },
  "requests.action_error": { ru: "Ошибка выполнения действия", az: "Əməliyyat xətası", en: "Action failed" },
  "requests.search_placeholder": {
    ru: "Поиск: MKT-REQ-*, имя клиента, CRM-*, название услуги, поставщик...",
    az: "Axtar: MKT-REQ-*, müştəri adı, CRM-*, xidmət adı, təchizatçı...",
    en: "Search: MKT-REQ-*, customer name, CRM-*, service name, supplier...",
  },
  ...
  "order.action.process": { ru: "Принят в работу", az: "İşə götürüldü", en: "Taken into processing" },
  "order.action.markWaitingData": { ru: "Ожидание данных", az: "Məlumat gözlənilir", en: "Waiting for data" },
  "order.action.resumeProcessing": { ru: "Обработка возобновлена", az: "Emal bərpa edildi", en: "Processing resumed" },
  "order.action.confirm": { ru: "Готов к бронированию", az: "Bronlaşdırmaya hazır", en: "Ready for booking" },
  "order.action.send": { ru: "Передан в Booking", az: "Booking-ə ötürüldü", en: "Sent to Booking" },
  "order.action.complete": { ru: "Исполнен", az: "İcra edilib", en: "Fulfilled" },
  "order.action.close": { ru: "Закрыт", az: "Bağlanıb", en: "Closed" },
  "order.action.cancel": { ru: "Отменён", az: "Ləğv edilib", en: "Cancelled" },
  "order.action.problem": { ru: "Проблема", az: "Problem", en: "Problem" },
  "order.action.suspend": { ru: "Приостановлен", az: "Dayandırılıb", en: "Suspended" },
  "order.action_short.process": { ru: "Принять в работу", az: "İşə götür", en: "Start processing" },
  "order.action_short.markWaitingData": { ru: "Ожидать данные", az: "Məlumat gözlə", en: "Wait for data" },
  "order.action_short.resumeProcessing": { ru: "Возобновить обработку", az: "Emalı bərpa et", en: "Resume processing" },
  "order.action_short.confirm": { ru: "Готов к бронированию", az: "Bronlaşdırmaya hazırla", en: "Ready for booking" },
  "order.action_short.send": { ru: "Передать в Booking", az: "Booking-ə ötür", en: "Send to Booking" },
  "order.action_short.complete": { ru: "Исполнить", az: "İcra et", en: "Fulfill" },
  "order.action_short.close": { ru: "Закрыть", az: "Bağla", en: "Close" },
  "order.action_short.cancel": { ru: "Отменить", az: "Ləğv et", en: "Cancel" },
  "order.action_short.problem": { ru: "Отметить проблему", az: "Problem qeyd et", en: "Mark problem" },
  "order.action_short.suspend": { ru: "Приостановить", az: "Dayandır", en: "Suspend" },
  "order.action_confirm.close": { ru: "Закрыть заказ? Это терминальное действие.", az: "Sifarişi bağlamaq? Bu, son əməliyyatdır.", en: "Close this order? This is a terminal action." },
  "order.action_confirm.cancel": { ru: "Отменить заказ? Действие терминально.", az: "Sifarişi ləğv etmək? Bu, son əməliyyatdır.", en: "Cancel this order? This is a terminal action." },
  "order.action.busy": { ru: "Выполняется…", az: "Yerinə yetirilir…", en: "Working…" },
  "order.action.final_confirm": { ru: "Финальное подтверждение данных туристов", az: "Sərnişin məlumatlarının son təsdiqi", en: "Final confirmation of traveler data" },
  "order.action.update_traveler_d3": { ru: "Изменение данных туриста (сбор данных)", az: "Səyahətçi məlumatlarının dəyişdirilməsi (məlumat toplama)", en: "Traveler data change (collection)" },
  "order.action.update_travelers": { ru: "Изменение данных туристов", az: "Səyahətçi məlumatlarının dəyişdirilməsi", en: "Traveler data change" },
  "order.action.booking_confirmed": { ru: "Согласовано с Booking Center", az: "Booking Center ilə razılaşdırılıb", en: "Agreed with Booking Center" },
  "order.action.booking_rejected": { ru: "Отклонено Booking Center", az: "Booking Center tərəfindən rədd edilib", en: "Rejected by Booking Center" },
  "order.action.update_order_fields": { ru: "Изменение полей заказа", az: "Sifariş sahələrinin dəyişdirilməsi", en: "Order fields change" },
  ...
  "booking.milestone.completed": { ru: "Исполнено", az: "İcra edilib", en: "Completed" },
  "booking.milestone.cancelled": { ru: "Отменено", az: "Ləğv edilib", en: "Cancelled" },
  "booking.milestone.rejected": { ru: "Отклонено", az: "Rədd edilib", en: "Rejected" },
  "booking.action.prepare": { ru: "Запрос готовится к отправке поставщику", az: "Sorğu təchizatçıya göndərilməyə hazırlanır", en: "Preparing request to supplier" },
  "booking.action.send": { ru: "Запрос отправлен поставщику", az: "Sorğu təchizatçıya göndərildi", en: "Request sent to supplier" },
  "booking.action.requestClarification": { ru: "Запрошено уточнение у поставщика", az: "Təchizatçıdan dəqiqləşdirmə tələb olundu", en: "Clarification requested from supplier" },
  "booking.action.resume": { ru: "Обработка возобновлена", az: "Emal bərpa edildi", en: "Processing resumed" },
  "booking.action.confirm": { ru: "Бронирование подтверждено", az: "Bron təsdiqləndi", en: "Booking confirmed" },
  "booking.action.reject": { ru: "Отклонено поставщиком", az: "Təchizatçı tərəfindən rədd edildi", en: "Rejected by supplier" },
  "booking.action.service": { ru: "Услуга началась", az: "Xidmət başladı", en: "Service started" },
  "booking.action.requestChange": { ru: "Запрошено изменение", az: "Dəyişiklik tələb olundu", en: "Change requested" },
  "booking.action.resolveChange": { ru: "Изменение обработано", az: "Dəyişiklik emal edildi", en: "Change resolved" },
  "booking.action.requestCancellation": { ru: "Запрошена отмена", az: "Ləğv tələb olundu", en: "Cancellation requested" },
  "booking.action.complete": { ru: "Бронирование завершено", az: "Bron tamamlandı", en: "Booking completed" },
  "booking.action.cancel": { ru: "Бронирование отменено", az: "Bron ləğv edildi", en: "Booking cancelled" },
  "booking.action.problem": { ru: "Помечено проблемным", az: "Problemli kimi qeyd edildi", en: "Marked as problem" },
  "booking.action_short.prepare": { ru: "Подготовить", az: "Hazırla", en: "Prepare" },
  "booking.action_short.send": { ru: "Отправить", az: "Göndər", en: "Send" },
  "booking.action_short.requestClarification": { ru: "Уточнить", az: "Dəqiqləşdir", en: "Clarify" },
  "booking.action_short.resume": { ru: "Возобновить", az: "Bərpa et", en: "Resume" },
  "booking.action_short.confirm": { ru: "Подтвердить", az: "Təsdiqlə", en: "Confirm" },
  "booking.action_short.reject": { ru: "Отклонить", az: "Rədd et", en: "Reject" },
  "booking.action_short.service": { ru: "Начать услугу", az: "Xidmətə başla", en: "Start service" },
  "booking.action_short.requestChange": { ru: "Запросить изменение", az: "Dəyişiklik tələb et", en: "Request change" },
  "booking.action_short.resolveChange": { ru: "Обработать изменение", az: "Dəyişikliyi emal et", en: "Resolve change" },
  "booking.action_short.requestCancellation": { ru: "Запросить отмену", az: "Ləğv tələb et", en: "Request cancellation" },
  "booking.action_short.complete": { ru: "Завершить", az: "Tamamla", en: "Complete" },
  "booking.action_short.cancel": { ru: "Отменить", az: "Ləğv et", en: "Cancel" },
  "booking.action_short.problem": { ru: "Проблема", az: "Problem", en: "Problem" },
  // ── R2 Detail Visual System — registry shared labels ──
  "common.date_from": { ru: "С", az: "From", en: "From" },
  "common.date_to": { ru: "По", az: "To", en: "To" },
  "common.loading_short": { ru: "загрузка…", az: "yüklənir…", en: "loading…" },
  "orders.empty": { ru: "Заказов пока нет", az: "Hələ sifariş yoxdur", en: "No orders yet" },
  "orders.quick.bookings": { ru: "Связанные брони", az: "Əlaqəli bronlar", en: "Linked bookings" },
  "orders.quick.no_bookings": { ru: "Бронирований нет", az: "Bron yoxdur", en: "No bookings" },
  "orders.quick.payment_failed": { ru: "Неуспешный", az: "Uğursuz", en: "Failed" },
  "orders.quick.pending_refund": { ru: "Ожидает обработки", az: "Emal gözlənilir", en: "Pending processing" },
  "bookings.empty": {
    ru: "Бронирований пока нет — передайте заказ из Order Center",
    az: "Hələ bron yoxdur — Order Center-dən sifariş ötürün",
    en: "No bookings yet — send an order from Order Center",
  },
  // ── UI-DOC-ADMIN — Documents (admin/operator) ──
  "nav.documents": { ru: "Документы", az: "Sənədlər", en: "Documents" },
  "documents.status.NOT_ISSUED": { ru: "Не сформирован", az: "Hələ formalaşdırılmayıb", en: "Not issued" },
  "documents.status.ISSUED": { ru: "Сформирован", az: "Formalaşdırılıb", en: "Issued" },
  "documents.status.SUPERSEDED": { ru: "Заменён", az: "Əvəz olunub", en: "Superseded" },
  "documents.status.INVALIDATED": { ru: "Аннулирован", az: "Ləğv edilib", en: "Invalidated" },
  "documents.type.VOUCHER": { ru: "Ваучер", az: "Voucher", en: "Voucher" },
  "documents.type.PARTIAL_PAYMENT": { ru: "Частичная оплата", az: "Qismi ödəniş", en: "Partial payment" },
  "documents.type.REFUND": { ru: "Возврат", az: "Geri qaytarma", en: "Refund" },
  "documents.filter.type_all": { ru: "Все типы", az: "Bütün növlər", en: "All types" },
  "documents.filter.status_all": { ru: "Все статусы", az: "Bütün statuslar", en: "All statuses" },
  "documents.kpi.total": { ru: "Всего документов", az: "Bütün sənədlər", en: "Total documents" },
  "documents.kpi.voucher": { ru: "Ваучеры", az: "Voucherlər", en: "Vouchers" },
  "documents.kpi.partial_payment": { ru: "Частичные оплаты", az: "Qismi ödənişlər", en: "Partial payments" },
  "documents.kpi.refund": { ru: "Возвраты", az: "Geri qaytarmalar", en: "Refunds" },
  "documents.table.code": { ru: "Номер", az: "Kod", en: "Code" },
  "documents.table.type": { ru: "Тип", az: "Növ", en: "Type" },
  "documents.table.status": { ru: "Статус", az: "Status", en: "Status" },
  "documents.table.booking": { ru: "Бронь", az: "Bron", en: "Booking" },
  "documents.table.service_date": { ru: "Дата услуги", az: "Xidmət tarixi", en: "Service date" },
  "documents.table.amount": { ru: "Сумма", az: "Məbləğ", en: "Amount" },
  "documents.table.paid": { ru: "Оплачено", az: "Ödənilib", en: "Paid" },
  "documents.table.version": { ru: "Версия", az: "Versiya", en: "Version" },
  "documents.table.created": { ru: "Создан", az: "Yaradılıb", en: "Created" },
  "documents.search.placeholder": {
    ru: "Поиск: PPD-*, VCH-*, RFD-*, код брони…",
    az: "Axtar: PPD-*, VCH-*, RFD-*, bron kodu…",
    en: "Search: PPD-*, VCH-*, RFD-*, booking code…",
  },
  "documents.empty": { ru: "Документов пока нет", az: "Hələ sənəd yoxdur", en: "No documents yet" },
  ...
  "documents.detail.currency": { ru: "Валюта", az: "Valyuta", en: "Currency" },
  "documents.detail.payment_status": { ru: "Статус оплаты", az: "Ödəniş statusu", en: "Payment status" },
  "documents.detail.version": { ru: "Версия", az: "Versiya", en: "Version" },
  "documents.detail.created": { ru: "Создан", az: "Yaradılıb", en: "Created" },
  "documents.detail.traveler": { ru: "Турист", az: "Səyahətçi", en: "Traveler" },
  "documents.detail.download": { ru: "Скачать", az: "Yüklə", en: "Download" },
  "documents.detail.invalidate": { ru: "Аннулировать", az: "Ləğv et", en: "Invalidate" },
  "documents.detail.invalidate_title": { ru: "Аннулирование документа", az: "Sənədin ləğvi", en: "Invalidate document" },
  "documents.detail.invalidate_reason": { ru: "Причина аннулирования", az: "Ləğv səbəbi", en: "Invalidation reason" },
  "documents.detail.invalidate_confirm": { ru: "Подтвердить", az: "Təsdiq et", en: "Confirm" },
  "documents.detail.invalidate_cancel": { ru: "Отмена", az: "Ləğv et", en: "Cancel" },
  "documents.detail.invalidate_error": { ru: "Не удалось аннулировать", az: "Ləğv etmək mümkün olmadı", en: "Failed to invalidate" },
  "documents.detail.versions": { ru: "Версии", az: "Versiyalar", en: "Versions" },
  "documents.detail.history": { ru: "История", az: "Tarixçə", en: "History" },
  "documents.detail.no_versions": { ru: "Версий нет", az: "Versiya yoxdur", en: "No versions" },
  "documents.detail.no_history": { ru: "Записей истории нет", az: "Tarixçə qeydləri yoxdur", en: "No history entries" },
