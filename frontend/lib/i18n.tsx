...
export const DICT: Record<string, Record<Locale, string>> = {
  ...
  "marketplace.popular_destinations_title": { ru: "Популярные направления", az: "Populyar istiqamətlər", en: "Popular destinations" },
  "marketplace.popular_destinations_subtitle": { ru: "Куда едут путешественники", az: "Səyahətçilər hara gedir", en: "Where travelers go" },
  "marketplace.all_destinations": { ru: "Все направления", az: "Bütün istiqamətlər", en: "All destinations" },
