...
export const DICT: Record<string, Record<Locale, string>> = {
  ...
  "cc.queue.history": { ru: "История", az: "Tarix", en: "History" },
  "cc.queue.empty": { ru: "Нет ситуаций, требующих внимания", az: "Diqqet teleb eden veziyyet yoxdur", en: "No situations requiring attention" },
  "cc.queue.open": { ru: "Открыт", az: "Aciq", en: "Open" },
  "cc.queue.acknowledged": { ru: "Принято к сведению", az: "Qeyde alindi", en: "Acknowledged" },
  "cc.queue.resolved": { ru: "Решено", az: "Hell edildi", en: "Resolved" },
  ...
  "cc.queue.resolve": { ru: "Решить", az: "Hell et", en: "Resolve" },
  "cc.queue.dismiss": { ru: "Отклонить", az: "Rədd et", en: "Dismiss" },
  "cc.queue.detected": { ru: "Обнаружено", az: "Aşkar edildi", en: "Detected" },
  "cc.queue.lastObserved": { ru: "Последнее наблюдение", az: "Son gözlem", en: "Last observed" },
  "cc.queue.observations": { ru: "Наблюдений", az: "Gözlem", en: "Observations" },
  "cc.queue.entities": { ru: "Объектов", az: "Obyekt", en: "Entities" },
  // Signal code → title
  "cc.signal.BOOKING_CONFIRMATION_DELAY": { ru: "Задержка подтверждения бронирований", az: "Bron təsdiqi gecikmesi", en: "Booking Confirmation Delay" },
  "cc.signal.FAILED_PAYMENTS": { ru: "Неуспешные платежи", az: "Ugursuz odenisler", en: "Failed Payments" },
  "cc.signal.RECENT_CANCELLATIONS": { ru: "Недавние отмены заказов", az: "Son ləğvetmeler", en: "Recent Cancellations" },
  "cc.signal.PENDING_REFUNDS": { ru: "Ожидают обработки возвраты", az: "Geri qaytarma gozleyir", en: "Pending Refunds" },
  "cc.signal.UPCOMING_BOOKINGS": { ru: "Предстоящие бронирования", az: "Gələcək bronlar", en: "Upcoming Bookings" },
  "cc.signal.SERVICES_WITHOUT_SALES": { ru: "Услуги без продаж", az: "Satis olmadan xidmetler", en: "Services Without Sales" },
  // V3 AI Feed
