...
export const DICT: Record<string, Record<Locale, string>> = {
  ...
  "filters.geography": { ru: "География", az: "Coğrafiya", en: "Geography" },
  "filters.country": { ru: "Страна", az: "Ölkə", en: "Country" },
  "filters.city": { ru: "Город", az: "Şəhər", en: "City" },
  "filters.all_countries": { ru: "Все страны", az: "Bütün ölkələr", en: "All countries" },
  "filters.all_cities": { ru: "Все города", az: "Bütün şəhərlər", en: "All cities" },
  "filters.dates": { ru: "Даты", az: "Tarixlər", en: "Dates" },
  "filters.date_from": { ru: "Дата начала", az: "Başlama tarixi", en: "Start date" },
  "filters.date_to": { ru: "Дата окончания", az: "Bitmə tarixi", en: "End date" },
  "filters.travelers": { ru: "Туристы", az: "Turistlər", en: "Travelers" },
  "filters.adults": { ru: "Взрослые", az: "Böyüklər", en: "Adults" },
  "filters.children": { ru: "Дети", az: "Uşaqlar", en: "Children" },
  "filters.child_age": { ru: "Возраст ребёнка", az: "Uşağın yaşı", en: "Child age" },
  "filters.service_params": { ru: "Параметры услуги", az: "Xidmət parametrləri", en: "Service parameters" },
  ...
  "configurator.date_from": { ru: "Дата с", az: "Başlanğıc tarixi", en: "Date from" },
  "configurator.date_to": { ru: "Дата по", az: "Son tarix", en: "Date to" },
  ...
  "configurator.max_31_hint": { ru: "Максимум 31 день (ограничение поставщика Summer)", az: "Maksimum 31 gün (Summer təchizatçı limiti)", en: "Maximum 31 days (Summer supplier limit)" },
  "configurator.max_31_days": { ru: "Максимальный период — 31 день (ограничение Summer)", az: "Maksimum dövr — 31 gün (Summer limiti)", en: "Maximum range is 31 days (Summer limit)" },
  "configurator.invalid_range": { ru: "Дата окончания должна быть не раньше даты начала", az: "Bitiş tarixi başlanğıc tarixindən erkən olmamalıdır", en: "End date must be on or after start date" },
  ...
  "calendar.no_price": { ru: "Нет цены", az: "Qiymət yoxdur", en: "No price" },
  "calendar.absence_title": { ru: "Причина отсутствия", az: "Mövcud olmama səbəbi", en: "Absence reason" },
  "calendar.offers_for_date": { ru: "Варианты на эту дату", az: "Bu tarix üçün variantlar", en: "Offers for this date" },
  "calendar.one_way": { ru: "в один конец", az: "bir tərəfə", en: "one-way" },
