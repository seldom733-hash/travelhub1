...
export const DICT: Record<string, Record<Locale, string>> = {
  ...
  "cc.title": { ru: "Рабочий стол", az: "İdarəetmə Mərkəzi", en: "Command Center" },
  ...
  "cc.access_denied_hint": { ru: "У вас нет прав analytics.read для доступа к Рабочему столу.", az: "İdarəetmə Mərkəzinə giriş üçün analytics.read hüququ yoxdur.", en: "You need analytics.read permission to access Command Center." },
  "cc.auth_required": { ru: "Требуется авторизация", az: "Autentifikasiya tələb olunur", en: "Authentication required" },
  "cc.auth_hint": { ru: "Войдите, чтобы получить доступ к Рабочему столу.", az: "İdarəetmə Mərkəzinə girmək üçün daxil olun.", en: "Sign in to access Command Center." },
  ...
  "nav.command_center": { ru: "Рабочий стол", az: "İdarəetmə mərkəzi", en: "Command Center" },
  ...
  "analytics.kpi.gmv": { ru: "GMV", az: "GMV", en: "GMV" },
  "analytics.kpi.revenue": { ru: "Выручка", az: "Gəlir", en: "Revenue" },
  "analytics.kpi.net_revenue": { ru: "Чистая выручка", az: "Xalis gəlir", en: "Net Revenue" },
  ...
  "analytics.funnel.title": { ru: "Воронка конверсии", az: "Konvertasiyaворонки", en: "Conversion Funnel" },
