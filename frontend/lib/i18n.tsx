...
export const DICT: Record<string, Record<Locale, string>> = {
  ...
  "cc.access_denied_hint": { ru: "У вас нет прав analytics.read для доступа к Аналитике.", az: "Analitikaya giriş üçün analytics.read hüququ yoxdur.", en: "You need analytics.read permission to access Analytics." },
  "cc.auth_required": { ru: "Требуется авторизация", az: "Autentifikasiya tələb olunur", en: "Authentication required" },
  "cc.auth_hint": { ru: "Войдите, чтобы получить доступ к Аналитике.", az: "Analitikaya girmək üçün daxil olun.", en: "Sign in to access Analytics." },
