...
## ROUND 5B — CUSTOMER 360 + PARTNER 360 TABULAR UX CONSISTENCY
...
| Заказ | Дата | Партнёр | Состав / контекст | Сумма | Статус |
|---|---|---|---|---:|---|
...
| Бронирование | Дата | Услуга | Партнёр | Период / дата услуги | Сумма* | Статус |
|---|---|---|---|---|---:|---|
...
| Платёж | Дата | Что оплачено | Сумма | Способ оплаты | Статус |
|---|---|---|---:|---|---|
...
| Возврат | Дата | Что возвращено | Исходный платёж | Сумма | Причина | Статус |
|---|---|---|---|---:|---|---|
...
| Услуга | Тип | Статус | Цена / от | Создана / обновлена |
|---|---|---|---:|---|
