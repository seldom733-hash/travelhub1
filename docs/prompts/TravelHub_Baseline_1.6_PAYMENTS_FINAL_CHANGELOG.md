# TravelHub — Baseline 1.6 PAYMENTS FINAL — CHANGELOG
...
- Architecture Overview — Baseline 1.6 PAYMENTS FINAL
- Implementation Prompt Phase 1 — Baseline 1.6 PAYMENTS FINAL
- Implementation Prompt Phase 2 — Baseline 1.6 PAYMENTS FINAL
- Implementation Prompt Phase 3 — Baseline 1.6 PAYMENTS FINAL
- RBAC Matrix — Baseline 1.6 PAYMENTS FINAL
- Screen Design Brief — Baseline 1.6 PAYMENTS FINAL
...
## Baseline 1.6 — Marketplace Payments & Settlement

1. Finance ownership expanded with PaymentTerms, ProviderFee, CommissionAccrual, Settlement, Payout and LedgerTransaction.
2. Preferred settlement mode: SPLIT_AT_PAYMENT.
3. Fallback modes: PLATFORM_COLLECT and PARTNER_COLLECT.
4. Buyer Payment and Partner Payout formally separated.
5. Partner payout may use bank transfer independently from Buyer card PSP.
6. PaymentTerms supports full/partial/deposit/pay-later/pay-at-service.
7. ProviderFee separated from TravelHub Commission.
8. PARTNER_COLLECT uses CommissionAccrual/receivable.
9. Refund/chargeback/FX/payout reversal require immutable reverse/adjustment financial entries.
10. PSP/bank integrations remain provider-agnostic adapters with capability matrix.
11. SPLIT_AT_PAYMENT requires real provider-side allocation, not simulated internal split.
